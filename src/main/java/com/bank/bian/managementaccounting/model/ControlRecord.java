package com.bank.bian.managementaccounting.model;
...
/**
 * The BIAN control record for this service domain: "Management Account Procedure".
 *
 ...
 * to its asset type (Management Account). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Management Account Procedure";
